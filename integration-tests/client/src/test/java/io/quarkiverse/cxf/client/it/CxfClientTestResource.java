    ...
    public Map<String, String> start() {
        ...
        if (remoteHost == null) {
            try {
                ...
                props.put("cxf.it.calculator.proxy.host", remotehost);
                props.put("cxf.it.calculator.proxy.port", String.valueOf(TINY_PROXY_PORT));
                props.put("cxf.it.calculator.proxy.user", "proxyuser");
                props.put("cxf.it.calculator.proxy.password", "proxyuser");
            }
            return props;
        } catch (Exception e) {
